...
x(t) &= r\sin(\frac{2\pi}{T}t + \phi) \\
	...
	&= -3sin(\pi{t})\text{cm} \\
	\mathcal{L}{\brak{x(t)}} &= \int_{0}^{\infty} -3sin(\pi{t})e^{-st}\, ds \\
	&= \frac{-3}{2j} \int_{0}^{\infty} e^{-(s-j\pi)t} - e^{-(s+j\pi)t}\, ds \\
	X(s) &= \frac{-3\pi}{s^{2}+\pi^{2}} 
\end{align}
\item Similarly,
\begin{align}
x(t) &= r\sin(\frac{2\pi}{T}t + \phi) \\
	&= 2\sin(\frac{2\pi}{4}t + \frac{\pi}{2}) \\
	&= 2\cos(\frac{\pi}{2}t)\text{cm} \\
	\mathcal{L}{\brak{x(t)}} &= \int_{0}^{\infty} 2\cos(\frac{\pi}{2}t)e^{-st}\, ds \\
	&= \frac{1}{j} \int_{0}^{\infty} e^{-(s-j(\frac{\pi}{2}))t} - e^{-(s+j(\frac{\pi}{2}))t}\, ds \\
	X(s) &= \frac{8s}{4s^{2}+\pi^{2}}
	\end{align}
	\end{enumerate}
\end{document}
