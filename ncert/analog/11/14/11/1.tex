...
x(t) &= r\sin(\frac{2\pi}{T}t + \phi) \\
	...
	&= -3sin(\pi{t})\text{cm} \\
	\mathcal{L}{\brak{x(t)}} &= \int_{0}^{\infty} -3sin(\pi{t})e^{-st}\ \\
	&= \frac{-3}{2i} \int_{0}^{\infty} e^{-(s-i\pi)t} - e^{-(s+i\pi)t}\ \\
...
x(t) &= r\sin(\frac{2\pi}{T}t + \phi) \\
	...
	\mathcal{L}{\brak{x(t)}} &= \int_{0}^{\infty} 2\cos(\frac{\pi}{2}t)e^{-st}\ \\
	&= \frac{1}{i} \int_{0}^{\infty} e^{-(s-i(\frac{\pi}{2}))t} - e^{-(s+i(\frac{\pi}{2}))t}\ \\
